...
package soc_system_pkg is
	component AD1939_hps_audio_research is
		port (
			...
			AD1939_DAC3_channel : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- channel
			AD1939_DAC3_data    : in  std_logic_vector(31 downto 0) := (others => 'X'); -- data
			AD1939_DAC3_error   : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- error
			AD1939_DAC3_valid   : in  std_logic                     := 'X';             -- valid
			AD1939_DAC4_channel : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- channel
			AD1939_DAC4_data    : in  std_logic_vector(31 downto 0) := (others => 'X'); -- data
			AD1939_DAC4_error   : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- error
			AD1939_DAC4_valid   : in  std_logic                     := 'X';             -- valid
			...
			AD1939_DAC_DSDATA3  : out std_logic;                                        -- ad1939_dac_dsdata3
			AD1939_DAC_DSDATA4  : out std_logic                                         -- ad1939_dac_dsdata4
		);
	end component AD1939_hps_audio_research;
