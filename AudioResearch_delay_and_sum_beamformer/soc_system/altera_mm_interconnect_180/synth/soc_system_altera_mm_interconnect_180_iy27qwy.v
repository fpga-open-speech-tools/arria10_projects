// soc_system_altera_mm_interconnect_180_iy27qwy.v
...
`timescale 1 ps / 1 ps
module soc_system_altera_mm_interconnect_180_iy27qwy (
	...
	wire  [101:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> jtag_master_master_agent:rp_data
	...
	wire  [102:0] mic_array_0_s1_agent_rf_source_data;                                   // mic_array_0_s1_agent:rf_source_data -> mic_array_0_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] mic_array_0_s1_agent_rsp_fifo_out_data;                                // mic_array_0_s1_agent_rsp_fifo:out_data -> mic_array_0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                     // cmd_mux:src_valid -> mic_array_0_s1_agent:cp_valid
	wire  [101:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> mic_array_0_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                     // mic_array_0_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> mic_array_0_s1_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                             // cmd_mux:src_startofpacket -> mic_array_0_s1_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                               // cmd_mux:src_endofpacket -> mic_array_0_s1_agent:cp_endofpacket
	wire          jtag_master_master_agent_cp_valid;                                     // jtag_master_master_agent:cp_valid -> router:sink_valid
	wire  [101:0] jtag_master_master_agent_cp_data;                                      // jtag_master_master_agent:cp_data -> router:sink_data
	...
	wire          mic_array_0_s1_agent_rp_valid;                                         // mic_array_0_s1_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] mic_array_0_s1_agent_rp_data;                                          // mic_array_0_s1_agent:rp_data -> router_001:sink_data
	wire          mic_array_0_s1_agent_rp_ready;                                         // router_001:sink_ready -> mic_array_0_s1_agent:rp_ready
	wire          mic_array_0_s1_agent_rp_startofpacket;                                 // mic_array_0_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          mic_array_0_s1_agent_rp_endofpacket;                                   // mic_array_0_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          mic_array_0_s1_agent_rdata_fifo_out_valid;                             // mic_array_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] mic_array_0_s1_agent_rdata_fifo_out_data;                              // mic_array_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          mic_array_0_s1_agent_rdata_fifo_out_ready;                             // avalon_st_adapter:in_0_ready -> mic_array_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                         // avalon_st_adapter:out_0_valid -> mic_array_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                          // avalon_st_adapter:out_0_data -> mic_array_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                         // mic_array_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                         // avalon_st_adapter:out_0_error -> mic_array_0_s1_agent:rdata_fifo_sink_error
	...
	soc_system_altera_merlin_router_180_4qn3tqa router (
	...
	soc_system_altera_merlin_router_180_nl6zyvy router_001 (
	...
	soc_system_altera_merlin_demultiplexer_180_jh7dbka cmd_demux (
		.clk                (codec_clocks_sys_clk_clk),                                        //       clk.clk
		.reset              (jtag_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_yp3ydli cmd_mux (
		.clk                 (mic_array_clocks_sck_master_clk),               //       clk.clk
		.reset               (mic_array_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_ezafeci rsp_demux (
		.clk                (mic_array_clocks_sck_master_clk),               //       clk.clk
		.reset              (mic_array_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_sthvrba rsp_mux (
		.clk                 (codec_clocks_sys_clk_clk),                                        //       clk.clk
		.reset               (jtag_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (jtag_master_master_translator_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (jtag_master_master_translator_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
