...
set ::GLOBAL_soc_system_altera_emif_arch_nf_180_hlqzivq_corename soc_system_altera_emif_arch_nf_180_hlqzivq
...
set var(CA_BD_PKG_SKEW)                                          0.189
set var(CA_TO_CK_BD_PKG_SKEW)                                    -0.024
set var(DQS_BOARD_SKEW)                                          0.07
set var(DQS_TO_CK_BOARD_SKEW)                                    -0.33
...
set var(PHY_REF_CLK_FREQ_MHZ)                                    150.0
set var(PHY_REF_CLK_JITTER_PS)                                   10.0
set var(PLL_REF_CLK_FREQ_PS_STR)                                 "6672 ps"
