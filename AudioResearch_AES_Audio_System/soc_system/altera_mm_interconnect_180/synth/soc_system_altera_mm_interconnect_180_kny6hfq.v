// soc_system_altera_mm_interconnect_180_kny6hfq.v
...
`timescale 1 ps / 1 ps
module soc_system_altera_mm_interconnect_180_kny6hfq (
	...
	wire  [108:0] delay_and_sum_beamformer_0_avalon_slave_agent_rf_source_data;                // delay_and_sum_beamformer_0_avalon_slave_agent:rf_source_data -> delay_and_sum_beamformer_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [108:0] delay_and_sum_beamformer_0_avalon_slave_agent_rsp_fifo_out_data;             // delay_and_sum_beamformer_0_avalon_slave_agent_rsp_fifo:out_data -> delay_and_sum_beamformer_0_avalon_slave_agent:rf_sink_data
	...
	wire  [107:0] hps_h2f_lw_axi_master_agent_write_cp_data;                                   // hps_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [107:0] hps_h2f_lw_axi_master_agent_read_cp_data;                                    // hps_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [107:0] delay_and_sum_beamformer_0_avalon_slave_agent_rp_data;                       // delay_and_sum_beamformer_0_avalon_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [107:0] router_src_data;                                                             // router:src_data -> hps_h2f_lw_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [107:0] hps_h2f_lw_axi_master_wr_limiter_cmd_src_data;                               // hps_h2f_lw_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [107:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> hps_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [107:0] hps_h2f_lw_axi_master_wr_limiter_rsp_src_data;                               // hps_h2f_lw_axi_master_wr_limiter:rsp_src_data -> hps_h2f_lw_axi_master_agent:write_rp_data
	...
	wire  [107:0] router_001_src_data;                                                         // router_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [107:0] hps_h2f_lw_axi_master_rd_limiter_cmd_src_data;                               // hps_h2f_lw_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [107:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [107:0] hps_h2f_lw_axi_master_rd_limiter_rsp_src_data;                               // hps_h2f_lw_axi_master_rd_limiter:rsp_src_data -> hps_h2f_lw_axi_master_agent:read_rp_data
	...
	wire  [107:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> delay_and_sum_beamformer_0_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                           // delay_and_sum_beamformer_0_avalon_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> delay_and_sum_beamformer_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire  [107:0] delay_and_sum_beamformer_0_avalon_slave_burst_adapter_source0_data;          // delay_and_sum_beamformer_0_avalon_slave_burst_adapter:source0_data -> delay_and_sum_beamformer_0_avalon_slave_agent:cp_data
	...
	wire    [1:0] delay_and_sum_beamformer_0_avalon_slave_burst_adapter_source0_channel;       // delay_and_sum_beamformer_0_avalon_slave_burst_adapter:source0_channel -> delay_and_sum_beamformer_0_avalon_slave_agent:cp_channel
	...
	wire  [107:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> sysid_qsys_0_control_slave_burst_adapter:sink0_data
	...
	wire  [107:0] sysid_qsys_0_control_slave_burst_adapter_source0_data;                       // sysid_qsys_0_control_slave_burst_adapter:source0_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	soc_system_altera_merlin_router_180_e7ui6kq router (
	...
	soc_system_altera_merlin_router_180_e7ui6kq router_001 (
	...
	soc_system_altera_merlin_router_180_6yqffvy router_002 (
	...
	soc_system_altera_merlin_router_180_6yqffvy router_003 (
	...
	soc_system_altera_merlin_demultiplexer_180_3ephpti cmd_demux (
		.clk                (clk_hps_clk_clk),                                        //        clk.clk
		.reset              (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_3ephpti cmd_demux_001 (
		.clk                (clk_hps_clk_clk),                                        //        clk.clk
		.reset              (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_aogbhry cmd_mux (
		.clk                 (PLL_using_AD1939_MCLK_outclk0_clk),                            //       clk.clk
		.reset               (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_aogbhry cmd_mux_001 (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_6w2neaq rsp_demux (
		.clk                (PLL_using_AD1939_MCLK_outclk0_clk),                            //       clk.clk
		.reset              (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_ryto4cq rsp_demux_001 (
		.clk                (clk_hps_clk_clk),                                  //       clk.clk
		.reset              (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_n6zzczq rsp_mux (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_n6zzczq rsp_mux_001 (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
