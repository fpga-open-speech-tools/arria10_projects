...
package soc_system_pkg is
	component soc_system_altera_mm_interconnect_180_xupykdy is
		port (
			...
			delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset : in  std_logic                     := 'X';             -- reset
	...
	end component soc_system_altera_mm_interconnect_180_xupykdy;
