// soc_system_altera_mm_interconnect_180_xupykdy.v
...
`timescale 1 ps / 1 ps
module soc_system_altera_mm_interconnect_180_xupykdy (
		...
		input  wire        delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset, // delay_and_sum_beamformer_0_reset_reset_bridge_in_reset.reset
	...
	wire   [20:0] delay_and_sum_beamformer_0_avalon_slave_agent_m0_address;                    // delay_and_sum_beamformer_0_avalon_slave_agent:m0_address -> delay_and_sum_beamformer_0_avalon_slave_translator:uav_address
	...
	wire  [110:0] delay_and_sum_beamformer_0_avalon_slave_agent_rf_source_data;                // delay_and_sum_beamformer_0_avalon_slave_agent:rf_source_data -> delay_and_sum_beamformer_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [110:0] delay_and_sum_beamformer_0_avalon_slave_agent_rsp_fifo_out_data;             // delay_and_sum_beamformer_0_avalon_slave_agent_rsp_fifo:out_data -> delay_and_sum_beamformer_0_avalon_slave_agent:rf_sink_data
	...
	wire  [110:0] simple_gain_0_avalon_slave_agent_rf_source_data;                             // simple_gain_0_avalon_slave_agent:rf_source_data -> simple_gain_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [110:0] simple_gain_0_avalon_slave_agent_rsp_fifo_out_data;                          // simple_gain_0_avalon_slave_agent_rsp_fifo:out_data -> simple_gain_0_avalon_slave_agent:rf_sink_data
	...
	wire  [109:0] hps_h2f_lw_axi_master_agent_write_cp_data;                                   // hps_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [109:0] hps_h2f_lw_axi_master_agent_read_cp_data;                                    // hps_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire          delay_and_sum_beamformer_0_avalon_slave_agent_rp_valid;                      // delay_and_sum_beamformer_0_avalon_slave_agent:rp_valid -> router_002:sink_valid
	wire  [109:0] delay_and_sum_beamformer_0_avalon_slave_agent_rp_data;                       // delay_and_sum_beamformer_0_avalon_slave_agent:rp_data -> router_002:sink_data
	wire          delay_and_sum_beamformer_0_avalon_slave_agent_rp_ready;                      // router_002:sink_ready -> delay_and_sum_beamformer_0_avalon_slave_agent:rp_ready
	wire          delay_and_sum_beamformer_0_avalon_slave_agent_rp_startofpacket;              // delay_and_sum_beamformer_0_avalon_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          delay_and_sum_beamformer_0_avalon_slave_agent_rp_endofpacket;                // delay_and_sum_beamformer_0_avalon_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [109:0] simple_gain_0_avalon_slave_agent_rp_data;                                    // simple_gain_0_avalon_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [109:0] sysid_qsys_0_control_slave_agent_rp_data;                                    // sysid_qsys_0_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [109:0] router_src_data;                                                             // router:src_data -> hps_h2f_lw_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [109:0] hps_h2f_lw_axi_master_wr_limiter_cmd_src_data;                               // hps_h2f_lw_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [109:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> hps_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [109:0] hps_h2f_lw_axi_master_wr_limiter_rsp_src_data;                               // hps_h2f_lw_axi_master_wr_limiter:rsp_src_data -> hps_h2f_lw_axi_master_agent:write_rp_data
	...
	wire  [109:0] router_001_src_data;                                                         // router_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [109:0] hps_h2f_lw_axi_master_rd_limiter_cmd_src_data;                               // hps_h2f_lw_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [109:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [109:0] hps_h2f_lw_axi_master_rd_limiter_rsp_src_data;                               // hps_h2f_lw_axi_master_rd_limiter:rsp_src_data -> hps_h2f_lw_axi_master_agent:read_rp_data
	...
	wire  [109:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> delay_and_sum_beamformer_0_avalon_slave_burst_adapter:sink0_data
	...
	wire  [109:0] delay_and_sum_beamformer_0_avalon_slave_burst_adapter_source0_data;          // delay_and_sum_beamformer_0_avalon_slave_burst_adapter:source0_data -> delay_and_sum_beamformer_0_avalon_slave_agent:cp_data
	...
	wire  [109:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> simple_gain_0_avalon_slave_burst_adapter:sink0_data
	...
	wire  [109:0] simple_gain_0_avalon_slave_burst_adapter_source0_data;                       // simple_gain_0_avalon_slave_burst_adapter:source0_data -> simple_gain_0_avalon_slave_agent:cp_data
	...
	wire  [109:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> sysid_qsys_0_control_slave_burst_adapter:sink0_data
	...
	wire  [109:0] cmd_demux_001_src0_data;                                                     // cmd_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [109:0] crosser_002_out_data;                                                        // crosser_002:out_data -> cmd_mux:sink1_data
	...
	wire  [109:0] cmd_demux_001_src1_data;                                                     // cmd_demux_001:src1_data -> crosser_003:in_data
	...
	wire  [109:0] crosser_003_out_data;                                                        // crosser_003:out_data -> cmd_mux_001:sink1_data
	...
	wire  [109:0] rsp_demux_001_src0_data;                                                     // rsp_demux_001:src0_data -> crosser_006:in_data
	...
	wire  [109:0] crosser_006_out_data;                                                        // crosser_006:out_data -> rsp_mux:sink1_data
	...
	wire  [109:0] rsp_demux_001_src1_data;                                                     // rsp_demux_001:src1_data -> crosser_007:in_data
	...
	wire  [109:0] crosser_007_out_data;                                                        // crosser_007:out_data -> rsp_mux_001:sink1_data
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset),   //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (PLL_using_AD1939_MCLK_outclk0_clk),                                           //             clk.clk
		.reset                   (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
	...
	soc_system_altera_merlin_router_180_ba3jora router (
	...
	soc_system_altera_merlin_router_180_ba3jora router_001 (
	...
	soc_system_altera_merlin_router_180_q7mytwy router_002 (
	...
	soc_system_altera_merlin_router_180_q7mytwy router_003 (
	...
	soc_system_altera_merlin_router_180_q7mytwy router_004 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset),                // cr0_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_thtz5ei cmd_demux (
		.clk                (clk_hps_clk_clk),                                        //        clk.clk
		.reset              (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_thtz5ei cmd_demux_001 (
		.clk                (clk_hps_clk_clk),                                        //        clk.clk
		.reset              (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_iz2d6ai cmd_mux (
		.clk                 (PLL_using_AD1939_MCLK_outclk0_clk),                            //       clk.clk
		.reset               (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_iz2d6ai cmd_mux_001 (
		.clk                 (PLL_using_AD1939_MCLK_outclk0_clk),                            //       clk.clk
		.reset               (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_iz2d6ai cmd_mux_002 (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_6vw6e4y rsp_demux (
		.clk                (PLL_using_AD1939_MCLK_outclk0_clk),                            //       clk.clk
		.reset              (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_6vw6e4y rsp_demux_001 (
		.clk                (PLL_using_AD1939_MCLK_outclk0_clk),                            //       clk.clk
		.reset              (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_demultiplexer_180_hazctbq rsp_demux_002 (
		.clk                (clk_hps_clk_clk),                                  //       clk.clk
		.reset              (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_wug5bny rsp_mux (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_altera_merlin_multiplexer_180_wug5bny rsp_mux_001 (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	soc_system_altera_avalon_st_adapter_180_7g3x3ri #(
		...
		.in_rst_0_reset (delay_and_sum_beamformer_0_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
