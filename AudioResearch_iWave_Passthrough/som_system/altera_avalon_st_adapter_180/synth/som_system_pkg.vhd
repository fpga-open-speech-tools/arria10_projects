...
package som_system_pkg is
	component som_system_altera_avalon_st_adapter_180_bbxpcfy is
		generic (
	...
	end component som_system_altera_avalon_st_adapter_180_bbxpcfy;

	component som_system_altera_avalon_st_adapter_180_cgdcaea is
		generic (
			inBitsPerSymbol : integer := 8;
			inUsePackets    : integer := 0;
			inDataWidth     : integer := 8;
	...
	end component som_system_altera_avalon_st_adapter_180_cgdcaea;
