...
TOP_LEVEL_NAME="pll"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/intelfpga/19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/pll_altera_iopll_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../altera_iopll_191/sim/pll_altera_iopll_191_zrphyuq.vo" -work pll_altera_iopll_191 -cdslib ./cds_libs/pll_altera_iopll_191.cds.lib
