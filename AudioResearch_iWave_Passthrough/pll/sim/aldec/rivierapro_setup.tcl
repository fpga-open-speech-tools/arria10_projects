...
# ACDS 19.1 670 win32 2020.04.14.07:06:56
# ----------------------------------------
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/intelfpga/19.1/quartus/"
}
...
ensure_lib                      ./libraries/pll_altera_iopll_191
vmap       pll_altera_iopll_191 ./libraries/pll_altera_iopll_191
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_191/sim/pll_altera_iopll_191_zrphyuq.vo" -work pll_altera_iopll_191
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L pll_altera_iopll_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
